...
export function useSuperadminDomain(params: SuperadminParams | null) {
    ...
    const loadUsers = useUserStore(s => s.fetchAll);
    const loadedUsers = useUserStore(s => s.data);
    ...
    useEffect(() => {
        ...
        loadUsers();
        loadApplications();
    }, [loadApplications, loadBusinesses, loadMountains, loadTrails, loadUsers]);
