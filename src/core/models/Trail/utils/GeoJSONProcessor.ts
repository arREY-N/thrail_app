import { ICoordinate, ITrailStats } from "@/src/core/models/Trail/interfaces/Trail.types";
import computeTotalLength, { geoJSONToCoordinate } from "@/src/core/models/Trail/utils/TrailComputation";
