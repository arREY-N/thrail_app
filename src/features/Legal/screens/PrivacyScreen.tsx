/**
 * @file PrivacyScreen.tsx
 * @description View for displaying the Privacy Policy.
 */
...
/**
 * Props for the PrivacyContent component.
 * @param onScrollToBottom - Callback triggered when the user scrolls to the bottom of the privacy text.
 */
...
export const PrivacyContent = ({ onScrollToBottom }: LegalContentProps) => {
...
const PrivacyScreen = ({ onBackPress }: LegalScreenProps) => {
    const { isMobile } = useBreakpoints();

    return (
        <ScreenWrapper backgroundColor={Colors.BACKGROUND}>
            <CustomHeader centerTitle title="Privacy Policy" onBackPress={onBackPress} />
            <View 
