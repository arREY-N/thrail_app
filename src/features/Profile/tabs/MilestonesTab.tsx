...
const AchievementBadge = ({ title, icon, earned }: AchievementBadgeProps) => (
...
const StatBentoBox = ({ title, value, subLabel, subValue, icon, lib = "Ionicons", boxWidth }: StatBentoBoxProps) => (
...
const MilestonesTab = ({ stats }: MilestonesTabProps) => {
