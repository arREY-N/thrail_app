...
export const PRESET_SCENARIOS: ScenarioDefinition[] = [
    ...
    {
        id: 'scenario-2',
        title: '2. Rejected Documents Cancel',
        subtitle: 'Post-Rejection Sub-Approval Request',
        initialStatus: 'reservation-rejected',
        simulatedBookingStatus: 'for-cancellation',
        simulatedCancellationStatus: 'pending',
        cancelledBy: 'user',
...
export const STATUS_COVERAGE_MATRIX: CoverageItem[] = [
    ...
    },
    {
        status: 'pending-docs',
        category: 'Phase 1: Verification',
        existingOnBackend: 'Deprecated: Normalized to for-reservation in BookingFactory',
        displayedByUI: 'Unified into for-reservation (Pending tab)',
        verdict: 'FULL_UI',
        verdictLabel: '✅ Deprecated (Normalized)',
        catchRef: 'None',
        backendActionRequired: 'None. Automatically normalized at runtime in BookingFactory.',
    },
    {
